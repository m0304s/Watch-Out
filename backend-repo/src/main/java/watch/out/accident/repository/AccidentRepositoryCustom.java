...
public interface AccidentRepositoryCustom {
     ...
     * @return 사고 목록 DTO
     */
    List<AccidentListResponse> findAccidentList(PageRequest pageRequest, UUID areaUuid,
     ...
     */
    List<AccidentListResponse> findAccidentListForManager(PageRequest pageRequest, UUID managerUuid,
