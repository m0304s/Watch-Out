...
public class FcmController {
    ...
    public ResponseEntity<FcmTokenResponse> registerToken(
        ...
        FcmToken fcmToken = fcmTokenService.registerToken(request);
    ...
    public ResponseEntity<Void> removeToken(@Valid @RequestBody FcmTokenRequest request) {
    ...
    public ResponseEntity<FcmTokenResponse> getMyTokens() {
        FcmTokenResponse response = fcmTokenService.getMyTokens();
